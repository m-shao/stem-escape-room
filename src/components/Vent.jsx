...
function Vent() {
    ...
    return (
        <div className='w-[40vw]'>
            <svg className='w-full' viewBox="0 0 1610 918" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="vent-page">
                    <g id="vent">
                        <rect id="Rectangle 89" x="0.0874023" width="1609.83" height="918" fill="#454545" />
                        <rect id="Rectangle 90" x="43.9922" y="120.977" width="1522.02" height="718.744" fill="#1F1F1F" />
                        <rect id="Rectangle 91" x="73.2617" y="156.557" width="1463.48" height="654.698" fill="#454545" />
                        <path id="Rectangle 92" d="M102.53 227.72V199.255L1507.47 199.255V227.72L102.53 227.72Z" fill="#1F1F1F" />
                        <rect id="Rectangle 93" x="102.53" y="306" width="28.4651" height="1404.94"
                            transform="rotate(-90 102.53 306)" fill="#1F1F1F" />
                        <rect id="Rectangle 94" x="102.53" y="384.28" width="28.4651" height="1404.94"
                            transform="rotate(-90 102.53 384.28)" fill="#1F1F1F" />
                        <rect id="Rectangle 95" x="102.53" y="462.557" width="28.4651" height="1404.94"
                            transform="rotate(-90 102.53 462.557)" fill="#1F1F1F" />
                        <rect id="Rectangle 96" x="102.53" y="540.837" width="28.4651" height="1404.94"
                            transform="rotate(-90 102.53 540.837)" fill="#1F1F1F" />
                        <rect id="Rectangle 97" x="102.53" y="619.117" width="28.4651" height="1404.94"
                            transform="rotate(-90 102.53 619.117)" fill="#1F1F1F" />
                        <rect id="Rectangle 98" x="102.53" y="697.397" width="28.4651" height="1404.94"
                            transform="rotate(-90 102.53 697.397)" fill="#1F1F1F" />
                        <rect id="Rectangle 99" x="102.53" y="775.674" width="28.4651" height="1404.94"
                    ...
                    <g id="screws">
                        ...
                        <g id="screw-4" onClick={() => {setScrewsOpen([...screwsOpen, 4])}} className={(screwsOpen.includes(4) && "transition-all duration-1000 opacity-0")}>
                            ...
                            <rect id="Rectangle 113_4" x="35.6592" y="879.683" width="3.2381" height="31.3016"
                                transform="rotate(-90 35.6592 879.683)" fill="#1F1F1F" />
                        </g>
                    </g>
                </g>
            </svg>
