...
import Box2 from './items/Box2'

function Cupboard({setInventory, inventory}) {
    ...
    return (
        <svg width="586" height="790" viewBox="0 0 586 790" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="Group 31">
                ...
                <g className={inventory.includes("key") && "hidden"} id="Group 4" onClick={() => {!inventory.includes("key") && setInventory([...inventory, "key"])}}>
                    <Key/>
                </g>
